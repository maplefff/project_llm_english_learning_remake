...
exports.generate212Question = generate212Question;
...
const QUESTION_DATA_212_ITEM_SCHEMA = {
    ...
    properties: {
        original_text: { type: genai_1.Type.STRING },
 ...
 */
async function generate212Question(numberOfQuestions = 1, historySummary = "", difficultySetting = 70) {
...
Return ONLY the JSON array. No markdown formatting.`;
        // 取得 LLM 設定
        const config = LLMConfigService_1.LLMConfigService.getInstance().getConfig('2.1.2');
        ...
        const response = await GeminiAPIService_1.default.getResponse(prompt, {
            ...
            config,
        }, RateLimiter_1.PRIORITY_LEVELS.LOW, 'generator_212');
...
//# sourceMappingURL=212_generate.js.map