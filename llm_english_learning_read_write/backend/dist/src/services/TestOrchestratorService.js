        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (questionType === '1.1.1') {
                    cachedEntry = yield this.questionCacheService.getQuestionFromCache('1.1.1');
                }
                else if (questionType === '1.1.2') {
                    cachedEntry = yield this.questionCacheService.getQuestionFromCache('1.1.2');
                }
                else {
                    console.warn(`[DEBUG TestOrchestratorService.ts] startSingleTypeTest: 不支援的題型 ${questionType}`);
                    return null;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (originalQuestionClientData.type === '1.1.1') {
                    const nextCachedEntry = yield this.questionCacheService.getQuestionFromCache('1.1.1'); // nextCachedEntry is CacheEntry | null
