...
class TestOrchestratorService {
    ...
    formatQuestionForClient111(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.1.1', explanation: questionBody.explanation_of_Question });
    }
    formatQuestionForClient112(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.1.2', explanation: questionBody.explanation_of_Question });
    }
    formatQuestionForClient121(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.2.1', explanation: questionBody.explanation_of_Question });
    }
    formatQuestionForClient122(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.2.2', explanation: questionBody.explanation_of_Question });
    }
    formatQuestionForClient123(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.2.3', explanation: questionBody.explanation_of_Question });
    }
    formatQuestionForClient131(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.3.1', explanation: questionBody.explanation_of_Question });
    }
    formatQuestionForClient141(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.4.1', explanation: questionBody.explanation_of_Question });
    }
    formatQuestionForClient151(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.5.1', explanation: questionBody.explanation_of_Question });
    }
    formatQuestionForClient152(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.5.2', explanation: questionBody.explanation_of_Question });
    }
    formatQuestionForClient153(cacheId, questionBody) {
        return Object.assign(Object.assign({}, questionBody), { id: cacheId, type: '1.5.3', explanation: questionBody.explanation_of_Question });
    }
    startSingleTypeTest(questionType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                // 嘗試從快取獲取題目
                const cacheEntry = yield this.questionCacheService.getQuestionFromCache(questionType);
                if (cacheEntry) {
                    ...
                    // 直接生成題目
                    const generated = yield this.generateQuestionDirectly(questionType);
    ...
    generateQuestionDirectly(questionType) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // 動態導入QuestionGeneratorService
                const { QuestionGeneratorService } = yield Promise.resolve().then(() => __importStar(require('./QuestionGeneratorService')));
                const result = yield QuestionGeneratorService.generateQuestionByType(questionType, 70, // 預設難度
    ...
    submitAnswer(userQuestionId, userAnswer, originalQuestionClientData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (!originalQuestionClientData || originalQuestionClientData.id !== userQuestionId) {
                    console.error(`[DEBUG TestOrchestratorService.ts] submitAnswer: 提供的 originalQuestionClientData 無效或 questionId (${userQuestionId}) 不匹配 (${originalQuestionClientData === null || originalQuestionClientData === void 0 ? void 0 : originalQuestionClientData.id})`);
                    return null;
                }
                // 根據題型處理答案評分
                let correctAnswer;
                ...
                yield (0, HistoryService_1.saveHistoryEntry)(originalQuestionClientData.type, historyEntryPayload);
                console.log(`[DEBUG TestOrchestratorService.ts] submitAnswer: 歷史記錄已儲存`);
                // 獲取下一題 - 暫時只從相同題型獲取
                const nextQuestionForClient = yield this.startSingleTypeTest(originalQuestionClientData.type);
