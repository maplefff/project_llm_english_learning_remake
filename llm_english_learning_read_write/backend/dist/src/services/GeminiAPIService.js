        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const request = {
                    ...
                    config: Object.assign(Object.assign({}, generationConfig), { responseMimeType: (options === null || options === void 0 ? void 0 : options.responseSchema) ? "application/json" : undefined, responseSchema: options === null || options === void 0 ? void 0 : options.responseSchema }),
                };
                // 發送請求
                const response = yield ai.models.generateContent(request);
                ...
                if (options === null || options === void 0 ? void 0 : options.responseSchema) {
