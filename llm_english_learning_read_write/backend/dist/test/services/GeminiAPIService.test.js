...
describe('GeminiAPIService', () => {
    ...
    describe('Constructor (Module Initialization)', () => {
        ...
        it('案例 1.2: 若 API Key 缺失，GoogleGenerativeAI 建構子應拋出錯誤...', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('案例 1.2.1: 服務模組應在 API Key 缺失時記錄錯誤...', () => __awaiter(void 0, void 0, void 0, function* () {
            delete process.env.GEMINI_API_KEY;
    ...
    describe('getResponse', () => {
        ...
        it('案例 2.1: 不帶 Schema 呼叫，應返回純文字', () => __awaiter(void 0, void 0, void 0, function* () {
            const mockResponseText = '這是純文字回應';
            mockGenerateContent.mockResolvedValue({
                response: { candidates: [{ content: { parts: [{ text: mockResponseText }] } }] }
            });
            const result = yield service.getResponse(mockPrompt);
            expect(mockGenerateContent).toHaveBeenCalledWith(requestBodyBase);
            expect(result).toBe(mockResponseText);
        }));
        it('案例 2.4: 帶 Schema 呼叫，應成功返回解析後的 JSON 物件', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield service.getResponse(mockPrompt, { responseSchema: mockSchema });
            const expectedRequestBody = Object.assign(Object.assign({}, requestBodyBase), { generationConfig: {
        ...
        it('案例 2.5: 帶 Schema 呼叫 (陣列)，應成功返回解析後的 JSON 陣列', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield service.getResponse(mockPrompt, { responseSchema: mockSchemaArray });
            const expectedRequestBody = Object.assign(Object.assign({}, requestBodyBase), { generationConfig: {
                    responseMimeType: "application/json",
        ...
        it('案例 2.6: 帶 Schema 但 API 返回非 JSON 字串，應拋出解析錯誤', () => __awaiter(void 0, void 0, void 0, function* () {
            const { SchemaType } = require('@google/generative-ai');
            ...
            yield expect(service.getResponse(mockPrompt, { responseSchema: mockSchema }))
                .rejects.toThrow(/解析 Gemini API 的 JSON 回應時失敗/);
        }));
        it('案例 2.7: 帶 Schema 但 API 返回空文字，應拋出錯誤', () => __awaiter(void 0, void 0, void 0, function* () {
            const { SchemaType } = require('@google/generative-ai');
            const mockSchema = { type: SchemaType.OBJECT, properties: {} };
        ...
        it('案例 2.2: API 呼叫失敗時應拋出錯誤', () => __awaiter(void 0, void 0, void 0, function* () {
            const errorMessage = 'API 內部錯誤';
            mockGenerateContent.mockRejectedValue(new Error(errorMessage));
            yield expect(service.getResponse(mockPrompt))
        ...
        it('案例 2.3: 若 API_KEY 缺失，getResponse 應拋出錯誤', () => __awaiter(void 0, void 0, void 0, function* () {
            delete process.env.GEMINI_API_KEY;
        ...
        it('案例 2.8: API 回應結構無效時應拋出錯誤', () => __awaiter(void 0, void 0, void 0, function* () {
            mockGenerateContent.mockResolvedValue({
