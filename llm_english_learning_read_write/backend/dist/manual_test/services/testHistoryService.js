...
async function clearHistoryFile(questionType) {
...
async function runManualTests() {
    ...
    const savedEntry1_1 = await (0, HistoryService_1.saveHistoryEntry)(questionType1, entryData1_1);
    console.log("[ManualTest] 儲存結果 1.1:", savedEntry1_1 ? "成功" : "失敗", savedEntry1_1);
    console.log(`[ManualTest] 儲存題型 ${questionType1} 的第二筆記錄 (將成為最新的)...`);
    const savedEntry1_2 = await (0, HistoryService_1.saveHistoryEntry)(questionType1, entryData1_2);
    console.log("[ManualTest] 儲存結果 1.2:", savedEntry1_2 ? "成功" : "失敗", savedEntry1_2);
    console.log(`[ManualTest] 儲存題型 ${questionType2} 的第一筆記錄...`);
    const savedEntry2_1 = await (0, HistoryService_1.saveHistoryEntry)(questionType2, entryData2_1);
    ...
    const savedEntry3_1 = await (0, HistoryService_1.saveHistoryEntry)(questionType3, entryData3_1);
    ...
    const history1 = await (0, HistoryService_1.getHistory)(questionType1);
    ...
    const history2 = await (0, HistoryService_1.getHistory)(questionType2);
    ...
    const history3 = await (0, HistoryService_1.getHistory)(questionType3);
    ...
    const historyNonExistent = await (0, HistoryService_1.getHistory)('9.9.9');
    ...
    if (history1.length >= 2) {
        ...
        const history1_limit1 = await (0, HistoryService_1.getHistory)(questionType1, 1);
        console.log(`[ManualTest] 結果 (應有 1 筆):`, history1_limit1);
        console.log("\n[ManualTest] 獲取從第 2 筆開始的 1 筆記錄 (limit: 1, offset: 1)...");
        const history1_offset1_limit1 = await (0, HistoryService_1.getHistory)(questionType1, 1, 1);
        ...
        const history1_offset_overflow = await (0, HistoryService_1.getHistory)(questionType1, 5, 10);
